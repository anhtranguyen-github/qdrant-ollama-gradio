...
class DocumentRetrieverTool:
    def __init__(self, collection_name="rag-qdrant", embedding_model="nomic-embed-text:latest"):
    ...
    def load_initial_documents(self):
        """Load initial documents from web sources"""
        # This method is now replaced by load_test_documents and load_web_documents
        pass
...
with gr.Blocks(title="RAG Chat with Thinking") as demo:
